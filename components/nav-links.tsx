...
const NavLinks = () => {
    ...
    return (
        <div className="w-full flex lg:gap-[29px] xl:gap-[19px] items-center justify-center text-bg-foreground">
          ...
          <div className="relative mt-[70px] px-[39px] pb-[143px] max-w-[937px] w-full max-h-[533px] h-full before:absolute before:inset-0 before:bg-cover before:bg-center before:bg-[url('/images/navbar-background.svg')] before:mix-blend-overlay before:content-[''] ">
